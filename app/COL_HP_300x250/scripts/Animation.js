...
app.Animation = (function () {
	...
	function start() {
		...
		.to(cup1, .5, {x:"-=20", opacity: 0, ease: Sine.easeIn}, "+=2")
		.to(cup2, .5, {x:"-=20", opacity: 1, ease: Sine.easeOut})
		.to(cup2, .5, {x:"-=20", opacity: 0, ease: Sine.easeIn}, "+=2")
		.to(cup3, .5, {x:"-=20", opacity: 1, ease: Sine.easeOut})
		.to(cup3, .5, {x:"-=20", opacity: 0, ease: Sine.easeIn}, "+=2")
		.to(txt2, .5, {x:"-=20", opacity: 0, ease: Sine.easeIn}, "-=.25")
		.to(logo, .5, {opacity: 0}, "-=.5")
		.to(resolve, .5, {x:"-=20", opacity: 1, ease: Sine.easeOut})
